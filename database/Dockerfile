...
# base build command: docker build -t match-db:0.02 -f Dockerfile --build-arg EXPOSED_PORT=3306 --build-arg MYSQL_ROOT_PASSWORD=root .
# run command: docker run -d -p 3306:3306 --name match-db -e MYSQL_ROOT_PASSWORD=root match-db:0.02
